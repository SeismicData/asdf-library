 ...
 *****************************************************************************/
/**
 * @file gen_usage_provenance.h
 * @brief
 * @author Matthieu Lefebvre
 */

#ifndef _ASDF_GEN_USAGE_PROVENANCE_
#define _ASDF_GEN_USAGE_PROVENANCE_
 ...
 *        generate_usage_provenance.
 *
 * @param usage_provenance Pointer to the C string to deallocate.
 *
 * @note Bind C++ functions with the C API.
 */
...
#endif  // _ASDF_GEN_USAGE_PROVENANCE_
