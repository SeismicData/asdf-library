 ...
 *****************************************************************************/
/**
 * @file gen_wasGeneratedby_provenance.h
 * @brief
 * @author Matthieu Lefebvre
 */

#ifndef _ASDF_GEN_WASGENERATEDBY_PROVENANCE_
#define _ASDF_GEN_WASGENERATEDBY_PROVENANCE_
 ...
 *        generate_wasGeneratedby_provenance.
 *
 * @param wasGeneratedby_provenance Pointer to the C string to deallocate.
 *
 * @note Bind C++ functions with the C API.
 */
...
#endif  // _ASDF_GEN_WASGENERATEDBY_PROVENANCE_
