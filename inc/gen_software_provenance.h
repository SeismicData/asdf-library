...
#ifndef _ASDF_GEN_SOFTWARE_PROVENANCE_
#define _ASDF_GEN_SOFTWARE_PROVENANCE_
 ...
 *
 * @param software-name The email of the person, for instance "hans.mustermann@email.com"
